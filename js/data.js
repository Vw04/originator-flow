...
const DEMO_DATA = {
  ...
  users: [
    ...
    { id: 'user-h02', companyId: null, branchId: null, firstName: 'Daniel',   lastName: 'Okafor',   email: 'daniel.okafor@homium.io', role: 'operator',  onboardingStatus: 'active', lastLogin: '2026-04-25', nmlsId: null, phone: '202-555-0111', title: 'Compliance Counsel',       policies: ['platform_ops'] },
    { id: 'user-h03', companyId: null, branchId: null, firstName: 'Elena',    lastName: 'Vasquez',  email: 'elena.vasquez@homium.io', role: 'operator',  onboardingStatus: 'active', lastLogin: '2026-04-29', nmlsId: null, phone: '202-555-0112', title: 'Account Manager',          policies: ['platform_ops'] },
    { id: 'user-h04', companyId: null, branchId: null, firstName: 'Thomas',   lastName: 'Reeves',   email: 'thomas.reeves@homium.io', role: 'operator',  onboardingStatus: 'active', lastLogin: '2026-04-20', nmlsId: null, phone: '202-555-0113', title: 'Finance Operations',       policies: ['platform_ops'] },
    { id: 'user-h05', companyId: null, branchId: null, firstName: 'Aiyana',   lastName: 'Brooks',   email: 'aiyana.brooks@homium.io', role: 'operator',  onboardingStatus: 'active', lastLogin: '2026-04-27', nmlsId: null, phone: '202-555-0114', title: 'Customer Success',         policies: ['platform_ops'] },
    { id: 'user-h06', companyId: null, branchId: null, firstName: 'Kenji',    lastName: 'Yamada',   email: 'kenji.yamada@homium.io',  role: 'operator',  onboardingStatus: 'active', lastLogin: '2026-04-30', nmlsId: null, phone: '202-555-0115', title: 'Engineering',              policies: ['platform_ops'] },
...
(function () {
  ...
  const LOANS = [
    ...
    {
      id: 'DCDC000009',
      borrower: 'Renee Beauchamp', borrowerFirst: 'Renee',
      address: '617 Quincy St NW', cityState: 'Washington, DC 20011',
      amount: 165000,
      stageIdx: 0, stageKey: 'pre',
      sla: 'green', daysInStage: 2,
      progress: progressFor(0),
      updatedAgo: '1h ago', updatedHours: 1,
      nextAction: 'Submit pre-qualification questionnaire', nextActor: 'borrower',
      owners: [{ name: 'James Okafor', initials: 'JO', org: 'CC Lending' }],
      underwriter: { name: 'Priya Shah', org: 'Homium' },
      aiNudge: 'Income range fits Dream Fund tier 2 — questionnaire should clear pre-qual on first pass.',
      program: { name: 'DC Dream Fund' },
      stips: [
        { id: 's1', label: 'Pre-qual questionnaire', status: 'pending',  owner: 'borrower' },
        { id: 's2', label: 'Soft credit pull',       status: 'received', owner: 'system' },
      ],
    },
    {
      id: 'DCDC000010',
      borrower: 'Andre Coleman', borrowerFirst: 'Andre',
      address: '2154 R St NW', cityState: 'Washington, DC 20008',
      amount: 195000,
      stageIdx: 1, stageKey: 'app',
      sla: 'green', daysInStage: 3,
      progress: progressFor(1),
      updatedAgo: '4h ago', updatedHours: 4,
      nextAction: 'Verify employment with HR contact', nextActor: 'processor',
      owners: [{ name: 'Dana Hill', initials: 'DH', org: 'CC Lending' }],
      underwriter: { name: 'Priya Shah', org: 'Homium' },
      aiNudge: 'Application complete; processor has the VOE request out — typical turnaround 1–2 business days.',
      program: { name: 'DC Dream Fund' },
      stips: [
        { id: 's1', label: 'Full application',  status: 'received', owner: 'borrower' },
        { id: 's2', label: 'VOE',               status: 'pending',  owner: 'processor' },
        { id: 's3', label: 'Hard credit pull',  status: 'received', owner: 'system' },
        { id: 's4', label: 'Bank statements',   status: 'received', owner: 'borrower' },
      ],
    },
    {
      id: 'DCDC000011',
      borrower: 'Jamal Ferguson', borrowerFirst: 'Jamal',
      address: '4408 Hayes St NE', cityState: 'Washington, DC 20019',
      amount: 145000,
      stageIdx: 3, stageKey: 'uw',
      sla: 'red', daysInStage: 14,
      progress: progressFor(3, { blocked: true }),
      updatedAgo: '2d ago', updatedHours: 48,
      nextAction: 'Resolve self-employment income discrepancy', nextActor: 'underwriter',
      owners: [{ name: 'James Okafor', initials: 'JO', org: 'CC Lending' }],
      underwriter: { name: 'Marcus Webb', org: 'Homium' },
      aiNudge: 'Stalled 14 days — 1099 totals do not reconcile with bank deposits. Recommend escalating to senior UW for a CPA letter exception.',
      program: { name: 'DC Dream Fund' },
      stips: [
        { id: 's1', label: 'Tax returns (2 yr)',  status: 'received', owner: 'borrower' },
        { id: 's2', label: '1099 reconciliation', status: 'blocked',  owner: 'underwriter' },
        { id: 's3', label: 'CPA letter',          status: 'pending',  owner: 'borrower' },
        { id: 's4', label: 'Bank statements',     status: 'received', owner: 'borrower' },
      ],
    },
    {
      id: 'DCDC000012',
      borrower: 'Olivia Nakamura', borrowerFirst: 'Olivia',
      address: '826 Maryland Ave NE', cityState: 'Washington, DC 20002',
      amount: 210000,
      stageIdx: 4, stageKey: 'cda',
      sla: 'green', daysInStage: 3,
      progress: progressFor(4),
      updatedAgo: '5h ago', updatedHours: 5,
      nextAction: 'Sign updated condition memo', nextActor: 'borrower',
      owners: [{ name: 'Dana Hill', initials: 'DH', org: 'CC Lending' }],
      underwriter: { name: 'Priya Shah', org: 'Homium' },
      aiNudge: 'Conditions are light — borrower e-signature is the only blocker before clear-to-close.',
      program: { name: 'DC Dream Fund' },
      stips: [
        { id: 's1', label: 'COA memo',                 status: 'received', owner: 'underwriter' },
        { id: 's2', label: 'Borrower acknowledgement', status: 'pending',  owner: 'borrower' },
        { id: 's3', label: 'Hazard insurance binder',  status: 'received', owner: 'borrower' },
      ],
    },
    {
      id: 'DCDC000013',
      borrower: 'Eliana Reyes', borrowerFirst: 'Eliana',
      address: '3322 Sherman Ave NW', cityState: 'Washington, DC 20010',
      amount: 188000,
      stageIdx: 5, stageKey: 'ctc',
      sla: 'amber', daysInStage: 9,
      progress: progressFor(5),
      updatedAgo: '1d ago', updatedHours: 24,
      nextAction: 'Title curative — release of prior lien', nextActor: 'title',
      owners: [{ name: 'James Okafor', initials: 'JO', org: 'CC Lending' }],
      underwriter: { name: 'Marcus Webb', org: 'Homium' },
      aiNudge: 'Title curative is taking longer than typical — recommend a check-in with the title agent today.',
      program: { name: 'DC Dream Fund' },
      stips: [
        { id: 's1', label: 'Title commitment',  status: 'received', owner: 'title' },
        { id: 's2', label: 'Release of lien',   status: 'pending',  owner: 'title' },
        { id: 's3', label: 'Closing disclosure', status: 'received', owner: 'borrower' },
        { id: 's4', label: 'Wire instructions', status: 'pending',  owner: 'closing' },
      ],
    },
